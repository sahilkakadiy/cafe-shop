import 'package:coffee/CoffeeApp/Auth/signup_auth.dart';
...
import '../Page/BottomBar_Coffee.dart';
    ...
    return Scaffold(
      body: StreamBuilder<User?>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return const BottenBarChat(); //here i will impliment the user login functionality
          } else {
